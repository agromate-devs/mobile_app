<script>
	...
	import { plant_settings } from '../lib/states.svelte';
	...
	<div style="margin-left: 8%;">
		...
		<div class="color-piker">
			<List strongIos outlineIos>
                ...
                placeholder="Color"
                readonly
                value={plant_settings.illuminazione.wheePickerValue}
                onColorPickerChange={(value) => plant_settings.illuminazione.wheePickerValue = value}
                colorPickerParams={{
                ...
                {#snippet media()}
	                    ...
	                    style={`background-color: ${plant_settings.illuminazione.wheePickerValue.hex}`}
	...
	></i>
		...
		<div class="grid grid-cols-2">
			<ListInput
				...
				value={plant_settings.illuminazione.ora_inizio}
			>
				{#snippet media()}
			...
			<ListInput
				...
				type="datetime-local"
				placeholder="Please choose..."
				value={plant_settings.illuminazione.ora_fine}
			>
				{#snippet media()}
								<i class="icon demo-list-icon" ></i>
							{/snippet}
			...
			<List simpleList strongIos outlineIos>
				<ListItem>
					...
					<Range
						...
						max={100}
						step={1}
						bind:value={plant_settings.illuminazione.value}
						label={true}
						color="orange"
						style="margin: 0;"
					/>
					<span style="position: relative; left: 15px; margin: 0;">{plant_settings.illuminazione.value}C</span>
					</div>
				</ListItem>
			</List>
		</div>
